...
Coursera](https://github.com/BGouissem/Reproducible-Research)
...
![](PA1_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
![](PA1_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
ggplot(IntervalDT , aes(x = interval , y = steps, color=`weekday or weekend`)) + geom_line(color="blue") + labs(title = "Avg. Daily Steps by Weektype", x = "Interval", y = "No. of Steps") + facet_wrap(~`weekday or weekend` , ncol = 1, nrow=2)
```

![](PA1_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
